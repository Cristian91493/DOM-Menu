...
topMenuEl.addEventListener('click',function(evt){
  ...
  //   return console.log('Not an "A" element')
  // }
  evt.target.nodName !== "A"? console.log('Not an "A" element'):console.log(evt.target)

  // evt.target.classList.contains() !== "active"? evt.target.classList.remove('active'):
...
subMenuEl.addEventListener('click',function(evt){
  ...
  let finalText = `<h1>${textClicked.toUpperCase()}</h1>`
